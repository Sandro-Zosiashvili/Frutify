...
import { message } from "@/public/CONSTS/Fruit";
...
const AddProduct = () => {
  ...
  const onsubmit = async (products: CreateProductForm) => {
    try {
      await axios.post('http://10.10.51.21:3001/products', products);
      // ('produqti warmatbit daebata') // It seems this line is unnecessary
      reset();
      ...
      <div className={styles.mainWrapper}>
        <form onSubmit={handleSubmit(onsubmit)} className={styles.formWrapper}>
          ...
          <div className={styles.formItem}>
            ...
            {errors.name  &&  <ErrorLabel value={"wesieri saxeli dawere shechema"} />}
          </div>
          <div className={styles.priceWrapper}>
            <div className={`${styles.formItem} ${styles.flexone}`}>
              ...
              {errors.price && <ErrorLabel value={errors.price.message || 'shecvale shechema'} />}
            </div>
